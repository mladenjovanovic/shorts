...
Setting `use_observed_MSS` parameter to `TRUE` in the `shorts::model_distance_velocity()` function also allows you to use observed peak velocity as MSS. 
...
Instead of providing for `TC`, this parameter can be estimated using `shorts::model_distance_time_TC()`.
