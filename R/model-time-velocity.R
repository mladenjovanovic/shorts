...
#' @description \code{model_time_velocity} estimates short sprint parameters using time-velocity trace
...
#' coef(sprint_model)
#' plot(sprint_model)
model_time_velocity <- function(time,
                                velocity,
                                weights = 1,
                                CV = NULL,
...
#' @rdname model_functions
#' @description \code{model_time_velocity_TC} estimates short sprint parameters using time-velocity trace,
...
#' sprint_model <- with(
#'   instant_velocity,
#'   model_time_velocity_TC(time, velocity)
#' )
#'
#' print(sprint_model)
#' coef(sprint_model)
#' plot(sprint_model)
model_time_velocity_TC <- function(time,
                                   velocity,
                                   weights = 1,
                                   CV = NULL,
                                   use_observed_MSS = FALSE,
